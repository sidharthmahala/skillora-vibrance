  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-0 w-full h-64 bg-gradient-to-b from-orkast-purple/10 to-transparent"></div>
        <div className="absolute bottom-0 right-0 w-full h-64 bg-gradient-to-t from-orkast-blue/10 to-transparent"></div>
        ...
        >
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-white/80 mt-6">
              In today's rapidly evolving world, traditional education often falls short. At Orkast, we bridge that gap by teaching the practical, cutting-edge skills that truly matter in the modern economy and digital age.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mt-16">
            <div className="glass-dark rounded-xl p-8 transition-all hover:translate-y-[-8px] hover:shadow-orkast-blue/20 hover:shadow-lg duration-300">
            ...
            <div className="glass-dark rounded-xl p-8 transition-all hover:translate-y-[-8px] hover:shadow-orkast-purple/20 hover:shadow-lg duration-300">
            ...
            <div className="glass-dark rounded-xl p-8 transition-all hover:translate-y-[-8px] hover:shadow-orkast-pink/20 hover:shadow-lg duration-300">
